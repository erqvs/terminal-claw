...
- Loads the hosted app at `https://terminal-claw.imbecile.cn:23333`
...
`npm run publish` uses Electron Forge's GitHub publisher and uploads artifacts to the `erqvs/terminal-claw` releases page.
